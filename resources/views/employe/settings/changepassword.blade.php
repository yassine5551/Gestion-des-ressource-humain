...
@endif
    ...
    <div class="mx-5">
        ...
        <form method="post" action="{{route ("employe.settings.changepassword.store")}}">
            @csrf
            @method('put')
            <div class="mb-6">
            ...
            <div class="mb-6">
                <label for="password" class="text-sm font-medium text-gray-900 block mb-2">Confirme nouveau mot de passe</label>
