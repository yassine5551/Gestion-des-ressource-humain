    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <h2 data-aos="fade-up" data-aos-delay="400">Suivez vos absences et congés très simplement vous devez seulement connecter</h2>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <p>Vala Bleu est une société privée forte de plus de 15 ans d'expérience dans l'enregistrement des noms de domaine, le déploiement et la gestion des plates-formes d'hébergement web de pointe.
                <br>
                Notre entreprise est en pleine expansion et ne fait appel qu'aux experts les plus compétents pour assurer aux clients un service de qualité inégalée et une meilleure présence sur le web.</p>
