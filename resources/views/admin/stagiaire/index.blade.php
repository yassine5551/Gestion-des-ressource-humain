                                        ...
                                        <td data-label="NOM COMPLET" class="p-2 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="w-10 h-10 flex-shrink-0 mr-2 sm:mr-3"><img class="rounded-full"
                                                        src={{ "https://avatars.dicebear.com/v2/initials/{$stagiaire->getFirstName()[0]}-{$stagiaire->getLastName()[0]}.svg" }}>
                                                </div>
                                                <div class="font-medium text-gray-800">{{ $stagiaire->getFirstName() }}
                                                    {{ $stagiaire->getLastName() }}</div>
                                            </div>
                                        </td>
                                        ...
                                        <td data-label="STATUS" class="p-2 whitespace-nowrap">
                                            <div class="text-lg text-center">
                                                @if ($stagiaire->getStatus())
                                                    <span
                                                        class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-green-500 text-white">
                                                        Terminé
                                                    </span>
                                                @else
                                                    <span
                                        ...
                                        <td data-label="actions" class="p-2 whitespace-nowrap ">
                                            <div class="flex items-center text-center">
                                                ...
                                                <form id="del_stg" method="post"
                                                    action="{{ route('admin.stagiaire.delete', $stagiaire->getId()) }}">
                                                    @csrf
                                                    @method('delete')
