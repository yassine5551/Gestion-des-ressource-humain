        ...
        <div class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog"
            ...
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-4">
                ...
                <div
                    ...
                    <form id="add_post" method="post" action="{{ route('admin.departement.store') }}" class="px-4 py-6">
                        @csrf
                        <!-- Form title -->
                        <div class="mb-6">
            ...
            <div class="overflow-x-auto resp">
                <table class="table-auto w-full">
                    ...
                    <tbody class="text-sm divide-y divide-gray-100">
                        @foreach ($departements as $key => $depart)
                            <tr>
                                ...
                                <td data-label="Nom de post" class="p-2 whitespace-nowrap">
                                    <div class="text-left font-medium">{{ $depart->name }}</div>
                                </td>
                                <td data-label="Nombre des employer" class="p-2 whitespace-nowrap">
                                    <div class="text-left font-medium">{{ $depart->posts->count() }}</div>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
