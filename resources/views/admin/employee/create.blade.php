            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <input name="email" type="email"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 text-gray-600"
                ...
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <label for="countries" class="block uppercase text-blueGray-600 text-xs font-bold mb-2">Sélectionnez
                            le poste</label>
                        <select name="post_id" id="countries"
                            class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 text-gray-600">
                            @foreach ($posts as $post)
                                <option {{ old('post_id') == $post->getId() ? 'selected' : '' }}
                                    value="{{ $post->getId() }}">
                                    {{ $post->getName() }}</option>
                            @endforeach
                        </select>
                ...
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <input name="salary" value="{{ old('salary') }}" type="text"
                            class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 text-gray-600">
                        @error('salary')
                            <div class="p-4 text-sm text-red-500 rounded-lg  bg-inherit " role="alert">
                                <span class="font-medium">{{ $message }}</span>
                ...
                <div class="w-full lg:w-12/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <textarea name="adress"
                            class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-5 text-gray-600 resize-none">{{ old('adress') }}</textarea>
                    </div>
                    @error('adress')
                        <div class="p-4 text-sm text-red-500 rounded-lg  bg-inherit " role="alert">
                            <span class="font-medium">{{ $message }}</span>
